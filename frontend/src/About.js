...
const about_photo = "https://i.ibb.co/1qXqG2T/Screenshot-2023-07-18-223132.jpg"
    ...
    return (
        <div className="About-Container">
            <br></br>
            <br></br>
            <h1 className="text-7xl text-center text-hautehouse_ltegold">About Us</h1>
            <br></br>
            <p className="text-center text-white">Welcome to Haute House, where hair dreams come to life!<br></br>
